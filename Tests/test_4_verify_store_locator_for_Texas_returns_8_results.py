...
from Outward.Pages.storeLocatorPage import StoreLocatorPage
...
class SearchTest(unittest.TestCase):
    ...
    def test_1_verify_valid_selection_returns_expected_result(self):
        ...
        test_verify_valid_selection_returns_expected_result.select_state("Texas")

        #Verify that state "Texas" has "8" expected store results
        test_verify_valid_selection_returns_expected_result.verify_store_count_accurate('Texas','8')
